...
<html lang="en">
  ...
  <body>
    ...
    <section class="section section-top section-full">
      ...
      <!-- Cover -->
      <div class="bg-cover" style="background-image: url(assets/img/20.jpg)">
      </div>
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                ...
                <div class="card card-sm border-0 text-center">
                  ...
                  <!-- Image -->
                  <img src="assets/img/19.jpg" alt="..." class="card-img-top">
    ...
    <section class="section">
      ...
      <!-- Cover -->
      <div class="bg-cover" style="background-image: url(assets/img/15.jpg);">
      </div>
