  ...
  <div class="">
      ...
      <form action="/cms/actualizar/servicio/{{$servicio->id}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
          ...
          <div class="col-12 mb-4">
            <h5>Descripción</h5>
            <textarea class="form-control" name="descripcion_servicio" rows="6">{{$servicio->descripcion}}</textarea>
          </div>
          <div class="col-12 mb-4">
          ...
          <div class="col-12 mb-5">
            <input type="submit" class="btn btn-success px-5" value="Actualizar Servicio">
          </div>
        </div>
      </form>
