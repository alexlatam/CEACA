...
<html lang="en">
  <head>
    @include("page_new.src.partialspartials.head")
  </head>
  <body>
        ...
        <div class="row form-row align-items-center">
          <div class="col-3">
            ...
            <div class="img-square">
              <img src="assets/img/62.jpg" alt="..." class="img-cover">
            </div>
          ...
          <div class="col-6">
            <div class="row form-row align-items-end mb-2">
              <div class="col-7">
                ...
                <div class="img-square">
                  <img src="assets/img/63.jpg" alt="..." class="img-cover">
                </div>
              ...
              <div class="col-5">
                ...
                <div class="img-square">
                  <img src="assets/img/64.jpg" alt="..." class="img-cover">
                </div>
            ...
            <div class="row form-row">
              <div class="col-5">
                ...
                <div class="img-square">
                  <img src="assets/img/65.jpg" alt="..." class="img-cover">
                </div>
              ...
              <div class="col-7">
                ...
                <div class="img-square">
                  <img src="assets/img/66.jpg" alt="..." class="img-cover">
                </div>
          ...
          <div class="col-3">
            ...
            <div class="img-square">
              <img src="assets/img/61.jpg" alt="..." class="img-cover">
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-lg-6">
            ...
            <!-- Heading -->
            <h2 class="mb-4">
              A team of passinate designers and developers who are <span class="text-primary">unmatched</span>
            </h2>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <blockquote class="blockquote border-left">
              <p>
                I cannot find any other design studio that can match Incline's prices and customer service!
              </p>
        ...
        <div class="row align-items-stretch">
          <div class="col-12 col-md-6 section pb-0 py-md-0">
            ...
            <div class="img-half img-half-left">
              <img src="assets/img/59.jpg" alt="..." class="img-cover">
            </div>
          ...
          <div class="col-12 col-md-6 col-xl-5 offset-xl-1 section">
            ...
            <!-- Heading -->
            <h3 class="mb-4">
              International design agency that <span class="text-primary">creates brands</span> for the most exciting companies in the world.
            </h3>

            <!-- Text -->
            <p>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rerum, laborum, accusantium! Hic possimus, cupiditate, perspiciatis animi doloremque tempora dolorum esse ullam qui odio eveniet cumque reiciendis nobis modi delectus porro!
            </p>

            <!-- Button -->
            <a href="#modal-video" data-toggle="modal" class="btn btn-lg btn-outline-primary btn-circle mr-3">
      ...
      <div class="container">
        <div class="row align-items-stretch">
          <div class="col-12 col-md-6 offset-xl-1 order-md-2">
            ...
            <!-- Image -->
            <div class="img-half">
              <img src="assets/img/60.jpg" alt="..." class="img-cover">
            </div>
          ...
          <div class="col-12 col-md-6 col-xl-5 order-md-1 section">
            ...
            <!-- Heading -->
            <h3 class="mb-4">
              We belive that the best projects result from the <span class="text-primary">flawless</span> communication. 
            </h3>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 col-md-12 col-lg-4">
            ...
            <!-- Preheading -->
            <p class="mb-2 font-weight-medium text-uppercase text-xs text-white text-muted">  
              Pricing options
            </p>
            ...
            <!-- Subheading -->
            <p class="mb-5 text-white text-muted">
              At iste soluta dolorem animi culpa libero delectus blanditiis, ut, aspernatur numquam voluptatum quas veniam.
            </p>

            <!-- Button -->
            <a href="#!" class="mb-5 mb-lg-0 btn btn-outline-primary text-white text-white">
              Schedule a meeting
            </a>
          ...
          <div class="col-12 col-md-6 col-lg-4"> 
            ...
            <!-- Card -->
            <div class="card card-lg shadow mb-3 mb-lg-0">
              ...
              <div class="card-body text-center">
                ...
                <!-- Text -->
                <ul class="card-text list-iconed text-white text-muted">
          ...
          <div class="col-12 col-md-6 col-lg-4">
            ...
            <!-- Card -->
            <div class="card card-active shadow card-lg mb-0">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-12 col-md-6 offset-lg-1">
            ...
            <p class="mb-5 text-muted">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores nobis ipsum officiis accusantium eveniet voluptatibus iusto, accusamus in, temporibus, numquam dicta laudantium.
            </p>
            ...
            <div class="row">
              <div class="col-12 col-lg-6">
                ...
                <div class="mb-5">
                  ...
                  <!-- Content -->
                  <p class="text-muted mb-0">
                    Necessitatibus nobis cupiditate eveniet repellat.
                  </p>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="card border-0 mb-3 mb-md-0">
              ...
              <!-- Image -->
              <img src="assets/img/54.jpg" class="card-img-top" alt="...">
