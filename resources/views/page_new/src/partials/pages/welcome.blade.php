    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <a href="app.html" class="card border-0 mb-3 mb-md-0">
          ...
          <div class="card-img-top">
            <img src="{{asset('img_plantilla/45.png')}}" alt="App landing" class="img-fluid">
          </div>
      ...
      <div class="col-md-4">
        ...
        <a href="company.html" class="card border-0 mb-3 mb-md-0">
          ...
          <!-- Image -->
          <div class="card-img-top">
            <img src="{{asset('img_plantilla/90.png')}}" alt="App landing" class="img-fluid">
          </div>
      ...
      <div class="col-md-4">
        ...
        <a href="fullpage.html" class="card border-0 mb-3 mb-md-0">
          ...
          <!-- Image -->
          <div class="card-img-top">
            <img src="{{asset('img_plantilla/57.png')}}" alt="Fullpage scrolling" class="img-fluid">
          </div>
      ...
      <div class="col-md-4">
        ...
        <a href="product.html" class="card border-0 mb-3 mb-md-0">
          ...
          <!-- Image -->
          <div class="card-img-top">
            <img src="{{asset('img_plantilla/44.png')}}" alt="App landing" class="img-fluid">
          </div>
      ...
      <div class="col-md-4">
        ...
        <a href="real-estate.html" class="card border-0 mb-3 mb-md-0">
          ...
          <!-- Image -->
          <div class="card-img-top">
            <img src="{{asset('img_plantilla/46.png')}}" alt="App landing" class="img-fluid">
          </div>
      ...
      <div class="col-md-4">
        ...
        <a href="restaurant.html" class="card border-0 mb-3 mb-md-0">
          ...
          <!-- Image -->
          <div class="card-img-top">
            <img src="{{asset('img_plantilla/91.png')}}" alt="App landing" class="img-fluid">
          </div>
      ...
      <div class="col-md-4">
        ...
        <a href="service.html" class="card border-0 mb-3 mb-md-0">
          ...
          <!-- Image -->
          <div class="card-img-top">
            <img src="{{asset('img_plantilla/43.png')}}" alt="App landing" class="img-fluid">
          </div>
    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <a href="index-header-carousel.html" class="card border-0 mb-3 mb-md-0">
          ...
          <!-- Image -->
          <div class="card-img-top">
            <img src="{{asset('img_plantilla/51.png')}}" alt="Carousel header" class="img-fluid">
          </div>
      ...
      <div class="col-md-4">
        ...
        <a href="index-header-parallax.html" class="card border-0 mb-3">
          ...
          <!-- Image -->
          <div class="card-img-top">
            <img src="{{asset('img_plantilla/52.png')}}" alt="Parallax header" class="img-fluid">
          </div>
      ...
      <div class="col-md-4">
        ...
        <a href="index-header-video.html" class="card border-0 mb-3 mb-md-0">
          ...
          <!-- Image -->
          <div class="card-img-top">
            <img src="{{asset('img_plantilla/53.png')}}" alt="Video header" class="img-fluid">
          </div>
    ...
    <div class="row align-items-center">
      <div class="col-md-6 col-lg-5 offset-lg-1 order-md-2">
        ...
        <div class="img-effect img-effect-solid mb-5 mb-md-0">
          <img src="{{asset('img_plantilla/47.jpg')}}" class="img-fluid" alt="...">
        </div>
    ...
    <div class="row no-gutters align-items-stretch">
      <div class="col-md-4">
        ...
        <div class="card card-tall card-stretch border-0 mb-3 md-md-0">
          ...
          <!-- Image -->
          <div class="bg-cover" style="background-image: url({{asset('img_plantilla/24.jpg')}})"></div>
      ...
      <div class="col-md-4">
        ...
        <div class="card card-tall card-stretch border-0">
          ...
          <!-- Image -->
          <div class="bg-cover" style="background-image: url({{asset('img_plantilla/15.jpg')}})"></div>
